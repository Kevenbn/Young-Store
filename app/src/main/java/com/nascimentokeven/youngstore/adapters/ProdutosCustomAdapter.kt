...
class ProdutosCustomAdapter(private val produtos: List<Produtos>) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.btcarrinho.setOnClickListener {
            openCarrinhoActivity(viewHolder.itemView, produto.titulo, produto.preco, produto.imagem)
        }
    }
    ...
    private fun openCarrinhoActivity(view: View, Titulo: String, Preco: String, Imagem: Int) {
